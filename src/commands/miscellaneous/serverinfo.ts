...
export const command: SlashCommand = {
    ...
    async execute(interaction: CommandInteraction<CacheType>) {
        ...
        const embed = new EmbedBuilder()
            .setTitle(`🌐 ${name}`)
            .setDescription(
                `Here's detailed information about the server ${name}`
            )
            .addFields(
                { name: '\u200B', value: '\u200B' },
                ...
                {
                    name: '🚀 Boosts',
                    value: premiumSubscriptionCount?.toString() || '0',
                    inline: true,
                }
            )
            .addFields(
                ...
                {
                    name: '😃 Emojis',
                    value: emojis.cache.size.toString(),
                    inline: true,
                }
            )
            .addFields(
                {
                    name: '📚 Channels',
                    value: channels.cache.size.toString(),
                    inline: true,
                },
                {
                    name: '⏰ AFK Channel',
                    value: afkChannel ? `<#${afkChannel.name}>` : 'None',
                    inline: true,
                },
                {
                    name: '⌛ AFK Timeout',
                    value: `${(afkTimeout / 60).toString()} minutes`,
                    inline: true,
                }
            )
            .addFields(
                {
                    name: '🚫 Bans',
                    value: bans.cache.size.toString(),
                    inline: true,
                },
                {
                    name: '🔒 MFA Level',
                    value: GuildMFALevel[mfaLevel],
                    inline: true,
                },
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: defaultMessageNotifications.toString(),
                    inline: true,
                },
                {
                    name: '🗣️ Explicit Content Filter',
                    value: GuildExplicitContentFilter[explicitContentFilter],
                    inline: true,
                }
            )
